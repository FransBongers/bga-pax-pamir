...
var SA_CIVIL_SERVICE_REFORM = 'civilServiceReforms';
        ...
        this.game.addPrimaryActionButton({
            ...
            callback: function () {
                return _this.game.takeAction({
                    action: 'purchaseGift',
                    data: { value: value, cardId: cardId },
                });
            },
        });
        this.game.addDangerActionButton({
...
var DiscardLeverageState = (function () {
    ...
    DiscardLeverageState.prototype.onEnteringState = function (_a) {
        var numberOfDiscards = _a.numberOfDiscards;
        this.numberOfDiscards = numberOfDiscards;
        this.updateInterfaceInitialStep();
    };
    ...
    DiscardLeverageState.prototype.updateInterfaceInitialStep = function () {
        ...
        this.game.setHandCardsSelectable({ callback: function (_a) {
                var cardId = _a.cardId;
                return _this.handleDiscardSelect({ cardId: cardId });
            } });
    };
    ...
    PlayerActionsState.prototype.updateInterfaceInitialStep = function () {
        ...
        if (this.activePlayerHasActions()) {
            ...
            this.game.setHandCardsSelectable({
                callback: function (_a) {
                    var cardId = _a.cardId;
                    _this.game.framework().setClientState(CLIENT_PLAY_CARD, { args: { cardId: cardId } });
                },
            });
                        ...
                        _this.game._connections.push(dojo.connect(child, 'onclick', _this, function (event) {
                            ...
                            switch (cardAction_1) {
                                case 'battle':
                                    ...
                                    break;
                                case 'betray':
                                    _this.game.framework().setClientState(CLIENT_CARD_ACTION_BETRAY, { args: { cardId: cardId } });
                                    break;
                                case 'build':
                                    _this.game.framework().setClientState(CLIENT_CARD_ACTION_BUILD, { args: { cardId: cardId } });
                                    break;
                                case 'gift':
                                    _this.game.framework().setClientState(CLIENT_CARD_ACTION_GIFT, { args: { cardId: cardId } });
                                    break;
                                case 'move':
                                    _this.game.framework().setClientState(CLIENT_CARD_ACTION_MOVE, { args: { cardId: cardId } });
                                    break;
                                case 'tax':
...
var NotificationManager = (function () {
    ...
    NotificationManager.prototype.notif_discardFromHand = function (notif) {
        ...
        this.game.clearPossible();
        var node = dojo.byId(notif.args.cardId);
