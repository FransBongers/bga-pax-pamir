...
var setupCardsStock = function (_a) {
    ...
    Object.keys(game.gamedatas.cards).forEach(function (cardId) {
        var cardFileLocation = useLargeCards
            ...
            : g_gamethemeurl +
                "img/temp/cards_medium/cards_tileset_medium_215_300.jpg";
        stock.addItemType(cardId, 0, cardFileLocation, useLargeCards
            ? Number(cardId.split("_")[1]) - 1
            : Number(cardId.split("_")[1]));
    });
...
var InteractionManager = /** @class */ (function () {
                ...
                dojo.query(".pp_card_in_court_".concat(playerId)).forEach(function (node) {
                    ...
                    if (!used &&
                        (_this.activePlayer.remainingActions > 0 ||
                            _this.game.gamedatas.cards[cardId].suit ===
                                _this.activePlayer.favoredSuit))
        ...
        switch (this.selectedAction) {
            case "purchase":
                dojo.query(".pp_market_card").forEach(function (node) {
                    ...
                    if (cost <= _this.activePlayer.rupees &&
                        !_this.activePlayer.unavailableCards.includes("card_" + cardId)) {
            ...
            case "discard_court":
                dojo
                    .query(".pp_card_in_court_".concat(this.game.getPlayerId()))
            ...
            case "placeSpy":
                dojo
                    .query(".pp_card_in_court_".concat((args === null || args === void 0 ? void 0 : args.region) ? args.region : ""))
                    .forEach(function (node, index) {
                    dojo.addClass(node, "pp_selectable_card");
                    this.handles.push(dojo.connect(node, "onclick", this, "onCard"));
                }, this);
    ...
    InteractionManager.prototype.onUpdateActionButtons = function (stateName, args) {
        ...
        switch (stateName) {
            ...
            case "playerActions":
                ...
                if (args.remaining_actions > 0) {
                    ...
                    if (args.court.some(function (_a) {
                        ...
                        return used == "0" &&
                            _this.game.gamedatas.cards[key].suit ==
                                args.favored_suit;
                    })) {
                        this.game.addActionButton("card_action_btn", _("Card Action"), "onCardAction");
                    }
            ...
            case "discardCourt":
                ...
                this.game
                    .framework()
                    .addActionButton("confirm_btn", _("Confirm"), "onConfirm", null, false, "blue");
    ...
    InteractionManager.prototype.onSelectGift = function (evt) {
        ...
        if (this.game.isCurrentPlayerActive()) {
            ...
            dojo
                .query("#pp_gift_".concat(value, "_").concat(this.game.getPlayerId()))
...
var NotificationManager = /** @class */ (function () {
    ...
    NotificationManager.prototype.notif_purchaseCard = function (notif) {
        ...
        this.game.marketManager.getMarketRupeesZone({ row: row, column: col }).getAllItems().forEach(function (rupeeId) {
    ...
    NotificationManager.prototype.notif_moveToken = function (notif) {
        ...
        notif.args.moves.forEach(function (move) {
            ...
            var addClass = to.startsWith("armies")
                ? "pp_army"
                : to.startsWith("roads")
                    ? "pp_road"
                    : undefined;
            var removeClass = from.startsWith("blocks")
                ? "pp_coalition_block"
                : undefined;
            _this.game.moveToken({
                id: token_id,
