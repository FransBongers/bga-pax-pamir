...
class InteractionManager {
  ...
  onUpdateActionButtons(stateName, args) {
    ...
    switch (stateName) {
      case 'setup':
        (this.game as unknown as Framework).addActionButton('afghan_button', _('Afghan'), 'onActionButtonClick', null, false, 'blue');
        (this.game as unknown as Framework).addActionButton('british_button', _('British'), 'onActionButtonClick', null, false, 'blue');
        (this.game as unknown as Framework).addActionButton('russian_button', _('Russian'), 'onActionButtonClick', null, false, 'blue');
        break;
      ...
      case 'playerActions':
        ...
        if (args.remaining_actions > 0) {
          main.innerHTML +=
            ...
            '</span>' +
            _(' action(s): ');
          (this.game as unknown as Framework).addActionButton('purchase_btn', _('Purchase'), 'onPurchase');
          (this.game as unknown as Framework).addActionButton('play_btn', _('Play'), 'onPlay');
          (this.game as unknown as Framework).addActionButton('card_action_btn', _('Card Action'), 'onCardAction');
          (this.game as unknown as Framework).addActionButton('pass_btn', _('End Turn'), 'onPass', null, false, 'gray');
        } else {
          main.innerHTML +=
            _(' have ') +
            '<span id="remaining_actions_value" style="font-weight:bold;color:#ED0023;">' +
          ...
          if (args.court.some(({ key, used }) => used == '0' && (this.game.gamedatas.cards[key] as CourtCard).suit == args.favored_suit)) {
            (this.game as unknown as Framework).addActionButton('card_action_btn', _('Card Action'), 'onCardAction');
          }
          (this.game as unknown as Framework).addActionButton('pass_btn', _('End Turn'), 'onPass', null, false, 'blue');
        }
        break;
      ...
      case 'client_confirmPurchase':
        (this.game as unknown as Framework).addActionButton('confirm_btn', _('Confirm'), 'onConfirm', null, false, 'blue');
        (this.game as unknown as Framework).addActionButton('cancel_btn', _('Cancel'), 'onCancel', null, false, 'red');
        break;

      case 'client_confirmPlay':
        (this.game as unknown as Framework).addActionButton('left_side_btn', _('<< LEFT'), 'onLeft', null, false, 'blue');
        (this.game as unknown as Framework).addActionButton('right_side_btn', _('RIGHT >>'), 'onRight', null, false, 'blue');
        (this.game as unknown as Framework).addActionButton('cancel_btn', _('Cancel'), 'onCancel', null, false, 'red');
        break;
      ...
      case 'client_confirmSelectGift':
        (this.game as unknown as Framework).addActionButton('confirm_btn', _('Confirm'), 'onConfirm', null, false, 'red');
        (this.game as unknown as Framework).addActionButton('cancel_btn', _('Cancel'), 'onCancel', null, false, 'gray');
        break;
      case 'placeRoad':
