...
class NotificationManager {
  ...
  notif_purchaseCard(notif) {
    ...
    this.game.marketManager.getMarketRupeesZone({row, column: col}).getAllItems().forEach((rupeeId) => {
      this.game.marketManager.getMarketRupeesZone({row, column: col}).removeFromZone(
        rupeeId,
        true,
