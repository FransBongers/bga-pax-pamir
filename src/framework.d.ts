...
interface Game {
    ...
    // Wrappers for framework functions
    // TODO (Frans): check if we can type these in any way without needing to implement them.
    formatBlockWrapper: (jstpId: string, args: Record<string, unknown>) => string;
}
